...
public class ClTests extends CL {
  ...
  public final static boolean addDelete2()
       throws InternalError, RequiredFailure,
	 ConstraintNotFound, NonlinearExpression
  {
    boolean fOkResult = true;
    Variable x = new Variable("x");
    ...
    solver
      .addConstraint( new LinearEquation(x, 100.0, Strength.weak))
      .addConstraint( new LinearEquation(y, 120.0, Strength.strong));
    ...
    LinearEquation cxy = new LinearEquation( CL.Times(2.0,x), y);
       ...
       throws InternalError, RequiredFailure
  {
    ...
    solver
      .addConstraint( new LinearInequality(x,CL.LEQ,y) )
      .addConstraint( new LinearEquation(y, CL.Plus(x,3.0)) )
      .addConstraint( new LinearEquation(x,10.0,Strength.weak) )
      .addConstraint( new LinearEquation(y,10.0,Strength.weak) )
      ;
       ...
       throws InternalError, RequiredFailure
  {
    try
      ...
      solver
	.addConstraint( new LinearEquation(x,10.0) )
	.addConstraint( new LinearEquation(x, 5.0) );
       ...
       throws InternalError, RequiredFailure
  {
    try
      ...
      solver
	.addConstraint( new LinearInequality(x,CL.GEQ,10.0) )
	.addConstraint( new LinearInequality(x,CL.LEQ, 5.0) );
       ...
       throws InternalError, RequiredFailure
  {
    try
      ...
      solver
	.addConstraint( new LinearInequality(w,CL.GEQ,10.0) )
	.addConstraint( new LinearInequality(x,CL.GEQ,w) )
	.addConstraint( new LinearInequality(y,CL.GEQ,x) )
	.addConstraint( new LinearInequality(z,CL.GEQ,y) )
	.addConstraint( new LinearInequality(z,CL.GEQ,8.0) )
	.addConstraint( new LinearInequality(z,CL.LEQ, 4.0) );
  ...
  public final static boolean addDel(int nCns, int nVars, int nResolves)
       throws InternalError, RequiredFailure,
	 NonlinearExpression, ConstraintNotFound
  {
  ...
  public final static void main( String[] args )
       throws InternalError, NonlinearExpression,
	 RequiredFailure, ConstraintNotFound, CassowaryError
  {
    //    try
    {
      ...
      if (CL.fGC) System.out.println("Num vars = " + AbstractVariable.numCreated() );
